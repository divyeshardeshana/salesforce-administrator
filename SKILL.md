...
| Lightning Experience & UX | `references/lightning-experience-ux.md` | Lightning apps, record pages, Dynamic Forms, Dynamic Actions, quick actions, list views, Path, in-app guidance, mobile, Classic migration |
| Integration Administration | `references/integration-admin.md` | Integration users, Connected Apps and OAuth scopes, Named Credentials, External Services, Salesforce Connect, Platform Events, API limits, SSO |
| AI & Data Cloud | `references/ai-and-data-cloud.md` | Einstein setup, Trust Layer, Prompt Builder, Agentforce topics and actions, predictive Einstein, Data Cloud ingestion and identity resolution |
